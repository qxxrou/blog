...
![](./image/Snipaste_2025-09-06_12-19-50.webp)
...
其实这样做是有好处的，能更好支持trss-shaking，组件也能更专注的实现逻辑，你想想有一些组件的样式并不是两三行css就能写出来的，其中还要考虑颜色主题，布局排版，况且某些组件还有各种各样的形态，全部写到一个.vue单文件组件里是有点不合适的,代码耦合度太高了。
